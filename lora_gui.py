...
def lora_tab(
    ...
    with gr.Tab('Folders'):
        with gr.Row():
            ...
            train_data_dir_folder = gr.Button('📂', elem_id='open_folder_small', enabled=False)
            ...
            reg_data_dir_folder = gr.Button('📂', elem_id='open_folder_small', enabled=False,)
        ...
        with gr.Row():
            ...
            output_dir_folder = gr.Button('📂', elem_id='open_folder_small', enabled=False,)
            output_dir_folder.click(get_folder_path, outputs=output_dir)
            logging_dir = gr.Textbox(
                label='Logging folder',
                placeholder='Optional: enable logging and output TensorBoard log to this folder',
            )
            logging_dir_folder = gr.Button('📂', elem_id='open_folder_small', enabled=False,)
    ...
    with gr.Tab('Training parameters'):
        with gr.Row():
            ...
            lora_network_weights_file = gr.Button(
                document_symbol, elem_id='open_folder_small', enabled=False,
            )
