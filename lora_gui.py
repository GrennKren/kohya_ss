...
def train_model(
    ...
    if stop_text_encoder_training_pct > 0:
        print('Output "stop text encoder training" is not yet supported. Ignoring')
...
def lora_tab(
    ...
    with gr.Tab('Folders'):
        with gr.Row():
            ...
            train_data_dir_folder = gr.Button('📂', elem_id='open_folder_small', visible=False)
            ...
            reg_data_dir_folder = gr.Button('📂', elem_id='open_folder_small', visible=False,)
        ...
        with gr.Row():
            ...
            output_dir_folder = gr.Button('📂', elem_id='open_folder_small', visible=False,)
            output_dir_folder.click(get_folder_path, outputs=output_dir)
            logging_dir = gr.Textbox(
                label='Logging folder',
                placeholder='Optional: enable logging and output TensorBoard log to this folder',
            )
            logging_dir_folder = gr.Button('📂', elem_id='open_folder_small', visible=False,)
    ...
    with gr.Tab('Training parameters'):
        with gr.Row():
            ...
            lora_network_weights_file = gr.Button(
                document_symbol, elem_id='open_folder_small', visible=False,
            )
